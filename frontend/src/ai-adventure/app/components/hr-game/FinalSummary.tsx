import { TrendingDown, Clock, Zap, AlertTriangle, CheckCircle, Home, Star, Lightbulb, X, ArrowLeft } from 'lucide-react';
...
export function FinalSummary({ onBack, scenarioId, scenarioTitle = 'HR Calibration Simulation', userEmail }: FinalSummaryProps) {
    ...
    <div className="h-full overflow-y-auto p-3">
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="inline-flex items-center gap-2 bg-green-50 border-2 border-green-500 rounded-full px-4 py-1.5 flex-shrink-0">
              ...
              <span className="text-green-900 font-bold text-xs">Calibration Complete!</span>
            </div>
          </div>
          ...
          <p className="text-sm text-gray-600 max-w-2xl mx-auto">
            You've experienced both the manual calibration struggle and the AI-powered solution. 
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <MetricCard
            label="Time to Calibrate"
            manual="8 Hours"
            agentic="15 Minutes (32x faster)"
          ...
          <MetricCard
            ...
            agentic="Automated Pattern Analysis"
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-2 text-red-700 text-xs">High (Manual review of all reviews)</td>
                  <td className="p-2 text-green-700 text-xs">Low (Reviewing flagged anomalies)</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="p-2 font-semibold text-gray-900 text-xs">User Role</td>
                  <td className="p-2 text-red-700 text-xs">Data Extractor</td>
                  <td className="p-2 text-green-700 text-xs">Strategic People Partner</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="p-2 font-semibold text-gray-900 text-xs">Coverage</td>
                  <td className="p-2 text-red-700 text-xs">Partial (3 of 12 reviews)</td>
                  <td className="p-2 text-green-700 text-xs">Complete (12 of 12 reviews)</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="p-2 font-semibold text-gray-900 text-xs">Daily Time Investment</td>
                  <td className="p-2 text-red-700 text-xs">8+ hours</td>
                  <td className="p-2 text-green-700 text-xs">15 minutes</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed text-xs">
                You are no longer a <strong>"Data Extractor."</strong> You are now a <strong>"Strategic People Partner."</strong> 
                Let the Agent analyze patterns while you focus on coaching and calibration.
              </p>
            </div>
            <div>
              <h4 className="text-[#E41E2B] font-bold mb-1 text-sm">🤝 Control</h4>
              <p className="text-gray-300 leading-relaxed text-xs">
                Automating tedious pattern detection, not replacing judgment. The AI provides <strong>"Data-Driven Evidence"</strong>, 
                so you can focus on <strong>"Fair & Objective Decisions."</strong>
              </p>
            </div>
          </div>
        </motion.div>
                ...
                {!submitted ? (
                  <>
                    ...
                    <p className="text-gray-700 mb-6 leading-relaxed">
                      ...
                      Your input is invaluable in helping us build scenarios that resonate with actual workflows.
                    </p>
                    ...
                    <div className="mb-6">
                      ...
                      <textarea
                        ...
                        placeholder="Example: Automating employee onboarding documentation review, where we spend hours checking compliance across multiple systems..."
