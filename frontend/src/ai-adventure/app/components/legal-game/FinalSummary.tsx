      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          ...
          <p className="text-sm text-gray-600 max-w-2xl mx-auto">
            You've experienced both the manual page-by-page review and the AI-powered solution. 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
          ...
          <MetricCard
            label="Risk Accuracy"
            manual="85% (Fatigue-Prone)"
            agentic="100% (Standard-Aligned)"
            icon={<Shield className="w-4 h-4" />}
          />
          
          <MetricCard
            label="Clause Coverage"
            manual="Sampled (Manual Read)"
            agentic="Complete (147 Clauses)"
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b-2 border-gray-200">
                <tr>
                  ...
                  <th className="text-left p-2 font-bold text-red-700 text-xs">The Manual Slog</th>
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-2 text-red-700 text-xs">High (Reading Every Page)</td>
                  <td className="p-2 text-green-700 text-xs">Low (Reviewing Highlights)</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="p-2 font-semibold text-gray-900 text-xs">User Role</td>
                  <td className="p-2 text-red-700 text-xs">Document Processor</td>
                  <td className="p-2 text-green-700 text-xs">Strategic Legal Counsel</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="p-2 font-semibold text-gray-900 text-xs">Extracting Clauses</td>
                  <td className="p-2 text-red-700 text-xs">Manual Reading/Copy-Paste</td>
                  <td className="p-2 text-green-700 text-xs">Instant Semantic Extraction</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="p-2 font-semibold text-gray-900 text-xs">Risk Benchmarking</td>
                  <td className="p-2 text-red-700 text-xs">Memory-Based Comparison</td>
                  <td className="p-2 text-green-700 text-xs">Database Playbook Check</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed text-xs">
                You are no longer a <strong>"Document Processor."</strong> You are now a <strong>"Strategic Legal Counsel."</strong> 
                Let the Agent extract clauses while you focus on business strategy.
              </p>
            </div>
            <div>
              <h4 className="text-[#E41E2B] font-bold mb-1 text-sm">🤝 Control</h4>
              <p className="text-gray-300 leading-relaxed text-xs">
                From reactive page-reading to proactive risk management. The AI provides the <strong>"Extract"</strong>, 
                so you can focus on the <strong>"Counsel."</strong>
              </p>
            </div>
          </div>
        </motion.div>
                  ...
                  <>
                    ...
                    <div className="mb-6">
                      ...
                      <textarea
                        ...
                        placeholder="Example: Automating NDA review for vendor onboarding, where we spend hours checking standard clauses against company templates..."
