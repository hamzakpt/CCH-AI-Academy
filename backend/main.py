...
@app.get("/analytics/admin/filter-options")
...
@app.get("/analytics/admin/growth")
...
@app.get("/analytics/admin/engagement")
...
@app.get("/analytics/admin/per-user")
...
@app.get("/analytics/admin/feedback")
